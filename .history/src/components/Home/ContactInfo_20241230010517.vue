...
const toast = useToast();
  ...
  navigator.clipboard
    ...
    .catch((error) => {
      ...
      toast.add({ severity: 'error', summary: 'Fail Copy Email', detail: 'Email Address Copy Failed', life: 2000 });
    });
}

const show = () => {
    console.log('check');
    toast.add({ severity: 'success', summary: 'Copy Email', detail: 'Email Address Copied', life: 2000 });
