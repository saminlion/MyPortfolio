...
export default {
  ...
  mounted() {
    ...
    // const modelPath = '/Model/tororo/tororo.model3.json';
    ...
    //   const modelDirectory = '/Model/hijiki/';
        ...
        const modelPath = '/Model/kero/';
    const modelFileName = 'kei_vowels_pro.model3.json';
    const motionPath = '/Model/kero/motions/';
    const motionName = '01_kei_ko';
