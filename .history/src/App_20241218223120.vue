...
export default {
  ...
  const modelPath = '/Model/Natori/Natori.model3.json';
   // const modelPath = 'Wanko.model3.json';
   const motionPath = '/Model/Natori/motions/';
   const motionName = 'mtn_01';
    const modelDirectory = '/Model/Natori/';

    const gl = canvas.getContext('webgl12', { alpha: true, premultipliedAlpha: true });
