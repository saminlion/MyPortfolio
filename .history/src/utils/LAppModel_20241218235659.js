...
export class LAppModel extends CubismUserModel {
    ...
    startIdleAnimation() {
        try {
            ...
            if (this.motionName) {
                motionFilePath = `${this.motionPath}/${this.motionName}.motion3.json`;
            }
            else {
                const idleMotionName = 'idle_motion'; // Idle 애니메이션 이름

                motionFilePath = `${this.motionPath}/${idleMotionName}.motion3.json`;
            }
