...
export class LAppModel extends CubismUserModel {
    ...
    async loadAssets() {
        try {
            ...
            const setting = new ICubismModelSetting(arrayBuffer, arrayBuffer.byteLength);
    ...
    startIdleAnimation() {
        try {
            ...
            const motionFilePath = this._modelSetting.getMotionFileName('idle', 0);//`${this.motionPath}/${this.motionName}.motion3.json`;
