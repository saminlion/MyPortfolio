...
export class LAppModel extends CubismUserModel {
    ...
    startRenderingLoop() {
        ...
        const render = () => {
            ...
            this.lastFrameTime = this.lastFrameTime || now; // 첫 번째 프레임 처리
            ...
            if (delta >= 1 / fps) {
                ...
                if (this._model && this._textures.length > 0) {
                    ...
                    if (this._pose != null) {
                        this._pose.updateParameters(this._model, delta / 30000); // 초 단위 경과 시간
                    }

                    this.motionManager.updateMotion(this._model, delta / 30000);
