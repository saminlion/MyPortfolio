...
export class Live2DLoader {
    ...
    async loadLive2DMotion() {
        try {
            ...
            const eyeblinkId = this.cubismModel.getParameterId(3);

            console.log('ebId:', eyeblinkId);
            // motion.setEffectIds(    this.cubismModel.getParameterIds('ParamEyeBlink'),
            // this.cubismModel.getParameterIds('ParamLipSync'))
