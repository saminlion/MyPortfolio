<template>
  ...
  const models = {
    home: { modelPath: '/Model/Wanko/', modelFileName: 'Wanko.model3.json',  motionName: '00_idle', poseFileName: '' },
    projects: { modelPath: '/Model/Haru/', modelFileName: 'Haru.model3.json', motionName: 'haru_g_m15', poseFileName: 'Haru.pose3.json' },
    about: { modelPath: '/Model/tororo/', modelFileName: 'tororo.model3.json', motionName: '00_idle' , poseFileName: 'tororo.pose3.json'},
  };
...
const currentModel = ref(models[currentPage.value] || models.home);
  ...
  function loadLive2DModel() {    
    ...
    const { modelPath, modelFileName, motionName, poseFileName } = currentModel.value;
    ...
    //console.log(`Loading Live2D model: ${modelPath}, ${modelFileName}, ${motionPath}, ${motionName}, ${poseFileName}`);
        console.log(`Loading Live2D model: ${modelPath}, ${modelFileName}, ${motionName}, ${poseFileName}`);
    ...
    try {
      ...
      live2DLoader.value = new LAppModel(canvas, modelPath, modelFileName, motionName, poseFileName);
