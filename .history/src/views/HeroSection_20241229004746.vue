...
const models = {
  ...
  projects: { modelPath: '/Model/Rice/', modelFileName: 'Rice.model3.json', motionName: 'haru_g_m15', poseFileName: '', scale: 1.2, xPos: 0, yPos: 0,groupName: 'TapBody', groupIndex: 0 },
