<template>
  ...
  const models = {
    home: { modelPath: '/Model/Wanko/', modelFileName: 'Wanko.model3.json', motionPath: '/Model/Wanko/', motionName: 'idle_01' },
    ...
    about: { modelPath: '/Model/tororo/', modelFileName: 'tororo.model3.json', motionPath: '/Model/tororo/', motionName: '00_idle' },
  };
