...
const models = {
  ...
  projects: { modelPath: '/Model/Gantzert_Felixander/', modelFileName: 'Gantzert_Felixander.model3.json', motionName: 'haru_g_m15', poseFileName: '', scale: 2, xPos: 0, yPos: 0, groupName: 'Idle', groupIndex: 0 },
