<template>
  ...
  const models = {
    ...
    projects: { modelPath: '/Model/Haru/', modelFileName: 'Haru.model3.json', motionName: 'haru_g_m15', poseFileName: 'Haru.pose3.json', scale: 1.2,xPos: 0, yPos: -150 },
    about: { modelPath: '/Model/tororo/', modelFileName: 'tororo.model3.json', motionName: '00_idle' , poseFileName: 'tororo.pose3.json', scale: 2,xPos: 0, yPos: -200},
  };
