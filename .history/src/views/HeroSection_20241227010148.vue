<template>
  ...
  const models = {
    home: { modelPath: '/Model/Wanko/', modelFileName: 'Wanko.model3.json', motionPath: '/Model/Wanko/motions', motionName: 'idle_01' },
    projects: { modelPath: '/Model/Hiyori/', modelFileName: 'Hiyori.model3.json', motionPath: '/Model/Hiyori/motions', motionName: 'Hiyori_m01' },
    about: { modelPath: '/Model/tororo/', modelFileName: 'tororo.model3.json', motionPath: '/Model/tororo/motions', motionName: '00_idle' },
  };
  ...
  function loadLive2DModel() {
    const { modelPath, modelFileName, motionPath, motionName } = currentModel.value;
