<template>
  ...
  <!-- 프로젝트 디테일 화면 -->
  <div v-if="currentProject" class="detail-section">
    <h2>{{ currentProject.name }}</h2>
    <img :src="currentProject.imageUrl" :alt="currentProject.name" class="detail-image" />
...
watch(
  ...
  (newPage) => {
    ...
    if (newPage === 'projects' && route.params.id) {
