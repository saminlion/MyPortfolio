...
function translate(index) {
  ...
  currentLanguage.value = languages[index].toUpperCase(); // 현재 언어 업데이트
  localStorage.setItem('currentLanguage', currentLanguage.value); // 언어 저장
}
