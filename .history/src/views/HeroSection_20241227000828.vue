<template>
    <section class="hero">
      <div class="hero-header">
        <nav class="nav-menu">
          <ul>
            <li>
              <router-link to="/" :class="{ active: currentPage === 'home' }">{{ ddd }}</router-link>
            </li>
            <li>
  ...
  const models = {
    home: { modelPath: '/Model/Wanko/', modelFileName: 'Wanko.model3.json', motionName: 'idle_01' },
    projects: { modelPath: '/Model/Haru/', modelFileName: 'Haru.model3.json', motionName: 'haru_g_idle' },
    about: { modelPath: '/Model/Tororo/', modelFileName: 'Tororo.model3.json', motionName: '00_idle' },
  };
