...
import koe from '../data/project_ko.json';
import ene from '../data/project_ko.json';
import jpe from '../data/project_ko.json';
...
// 초기 데이터 로드
onMounted(() => {
  loadProjects(defaultLanguage); // 초기 언어를 기본 언어로 설정
});

// 언어 변경 감지
watch(locale, (newLocale) => {
  const lang = newLocale || defaultLanguage; // 새 언어가 없으면 기본 언어 사용
  loadProjects(lang);
});
