<template>
  ...
  import Live2DWebGLApp from '../utils/Live2DWebGLApp.js';
  ...
  function loadLive2DModel() {
    ...
    if (live2DLoader.value) {
      live2DLoader.value = null;
    }
  
    live2DLoader.value = new Live2DWebGLApp(canvas, modelPath, modelFileName, motionPath, motionName);
  
    live2DLoader.value
      .initialize()
      .then(() => console.log('Live2D model loaded successfully!'))
      .catch((error) => console.error('Failed to initialize Live2D:', error));
  }
