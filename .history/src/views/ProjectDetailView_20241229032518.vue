<template>
  <div class="project-detail">
    ...
    <div class="tab-content" v-show="activeTab === 'demo' && currentProject?.demoVideo">
      <!--프로젝트 데모 영상-->
    ...
    <div class="tab-content" v-show="activeTab === 'role'">
      <!--프로젝트 주된 역활-->
    ...
    <div class="tab-content" v-show="activeTab === 'achive'">
      <!-- 프로젝트 성과 리스트 -->
      <ul>
        <li class="detail-list" v-for="(detail, index) in currentProject?.details" :key="index">
          {{ detail }}
