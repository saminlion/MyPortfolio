<template>
  <section class="hero">
    ...
    <div class="hero-content detail-layout">
        ...
        <!-- Project Detail View -->
        <div v-show="animationCompleted" v-if="isProject.valueOf() === true" class="project-detail-container">
          <ProjectDetailView />
        </div>

      <canvas ref="live2dCanvas" class="live2d-canvas" @click=""></canvas>
...
watch(
  ...
  (newPage) => {
    ...
    console.log('currentPage.value', currentPage.value, isProject.value);
